        ...
        <div class="modal-content" style="border-radius:6px; border:none; box-shadow:0 10px 30px rgba(0,0,0,0.15);">
            ...
            <div class="modal-header border-bottom px-4 py-3" style="background:#f8fafc; border-top-left-radius:6px; border-top-right-radius:6px;">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="javascript:void(0);" onclick="navigator.clipboard.writeText('var d=window.__PAGE_CONFIG__||window.__INITIAL_STATE__||window.agodaData||window.hotelResults||window.__NEXT_DATA__;if(d){navigator.clipboard.writeText(JSON.stringify(d));alert(\'🎉 Agoda Search JSON Copied!\');}else{alert(\'Open Agoda search page first!\');}');alert('✅ Network JSON Bookmarklet script copied to Clipboard!\n\n📌 Quick 3-Step Guide for Agoda:\n1. Open Agoda search page & Press F12\n2. Go to Network tab -> Filter: search\n3. Click getsearchhotelssync -> Copy Response & paste into importer!');" class="btn btn-sm btn-outline-primary fw-bold px-2.5 py-1 d-inline-flex align-items-center shadow-sm" style="font-size:11.5px; border-radius:4px; background:#fff;" title="Copy Network JSON Guide & Script">
