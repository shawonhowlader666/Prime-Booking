...
<div class="page-content-area">
    <div style="max-width:960px; margin:0 auto;">
        <form action="{{ route('admin.properties.store') }}" method="POST">
            ...
            @if ($errors->any())
                <div class="admin-alert error mb-4" style="border-radius:4px;">
            ...
            <div class="form-card mb-4" style="border-radius:4px; background:#ffffff; border:1px solid #e2e8f0; padding:20px;">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2.5 mb-3">
                    ...
                    <span class="badge bg-light text-secondary border" style="font-size:11px; border-radius:4px;">Required Fields *</span>
                </div>
                <div class="row g-3">
                    <div class="col-md-8">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Property / Hotel / Ship Full Name <span style="color:#ff4d4f;">*</span></label>
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                            placeholder="e.g. Royal Tulip Sea Pearl Beach Resort & Spa" required style="font-size:13px; border-radius:4px;">
                        <span class="text-secondary" style="font-size:11px; margin-top:3px; display:block;">Registered commercial name of the hotel, resort, or ship.</span>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="type" class="form-select" required style="font-size:13px; border-radius:4px;">
                    ...
                    <div class="col-md-5">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">City / Region Destination <span style="color:#ff4d4f;">*</span></label>
                        <select name="city" class="form-select" required style="font-size:13px; border-radius:4px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="star_rating" class="form-select" required style="font-size:13px; border-radius:4px;">
                    ...
                    <div class="col-md-3">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Assign to Vendor</label>
                        <select name="vendor_id" class="form-select" style="font-size:13px; border-radius:4px;">
                    ...
                    <div class="col-md-7">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Full Property Address <span style="color:#ff4d4f;">*</span></label>
                        <input type="text" name="address" class="form-control" value="{{ old('address') }}"
                            placeholder="e.g. Inani Beach, Marine Drive Road, Kolatoli, Cox's Bazar 4700, Bangladesh" required style="font-size:13px; border-radius:4px;">
                    </div>
                    <div class="col-md-5">
                        ...
                        <input type="text" name="nearest_landmark" class="form-control" value="{{ old('nearest_landmark') }}"
                            placeholder="e.g. 2 mins walk from Kolatoli Beach Point" style="font-size:13px; border-radius:4px;">
                    </div>
                </div>
            </div>

            {{-- SECTION 2: Pricing & Discount Setup --}}
            <div class="form-card mb-4" style="border-radius:4px; background:#ffffff; border:1px solid #e2e8f0; padding:20px;">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2.5 mb-3">
                    <h6 class="fw-bold text-dark mb-0 d-flex align-items-center gap-2" style="font-size:14.5px;">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div style="display:flex;">
                            <span class="input-group-text bg-light text-dark fw-bold" style="font-size:12px; border-radius:4px 0 0 4px;">৳ BDT</span>
                            <input type="number" name="price_per_night" class="form-control"
                                value="{{ old('price_per_night') }}" placeholder="8500" required style="font-size:13px; border-radius:0 4px 4px 0;">
                        </div>
                        <span class="text-secondary" style="font-size:11px; margin-top:3px; display:block;">Lowest room price per night.</span>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Original Crossed-Out Rate (BDT)</label>
                        <div style="display:flex;">
                            <span class="input-group-text bg-light text-muted" style="font-size:12px; border-radius:4px 0 0 4px;">৳ BDT</span>
                            <input type="number" name="original_price" class="form-control"
                                value="{{ old('original_price') }}" placeholder="11000" style="font-size:13px; border-radius:0 4px 4px 0;">
                        </div>
                        <span class="text-secondary" style="font-size:11px; margin-top:3px; display:block;">Shows as <s>BDT 11,000</s> with discount badge.</span>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Listing Visibility Status</label>
                        <select name="status" class="form-select" style="font-size:13px; border-radius:4px;">
                    ...
                    <div class="col-12 mt-2">
                        <div class="p-3 bg-light border d-flex align-items-center justify-content-between flex-wrap gap-2" style="border-radius:4px;">
            ...
            <div class="form-card mb-4" style="border-radius:4px; background:#ffffff; border:1px solid #e2e8f0; padding:20px;">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Primary / Thumbnail Image URL <span style="color:#ff4d4f;">*</span></label>
                        <input type="url" name="primary_image" id="primaryImgUrl" class="form-control"
                            ...
                            oninput="previewImage(this.value)" style="font-size:13px; border-radius:4px;">
                        <div id="imgPreviewWrap" class="mt-2" style="display:none;">
                            <img id="imgPreview" src="" style="height:85px; border-radius:4px; border:1px solid #cbd5e1; object-fit:cover;" alt="Preview">
                        </div>
                    </div>
                    <div class="col-12">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Official Video Property Tour URL (YouTube Embed / MP4 Link)</label>
                        <input type="url" name="video_url" class="form-control"
                            value="{{ old('video_url') }}" placeholder="e.g. https://www.youtube.com/embed/dQw4w9WgXcQ" style="font-size:13px; border-radius:4px;">
                        <span class="text-secondary" style="font-size:11px; margin-top:3px; display:block;">Enables 360 Video Tour button on search results &amp; detail pages.</span>
                    </div>
                    <div class="col-12">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Gallery Image URLs (one per line, max 10)</label>
                        ...
                        <span class="text-secondary" style="font-size:11px; margin-top:3px; display:block;">Enter each image URL on a new line for gallery slider.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card mb-4" style="border-radius:4px; background:#ffffff; border:1px solid #e2e8f0; padding:20px;">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2.5 mb-3">
                    ...
                    <span class="badge bg-light text-secondary border" style="font-size:11px; border-radius:4px;">SEO Description</span>
                </div>
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label" style="font-size:12.5px; font-weight:600; color:#1e293b;">Full Property Description <span style="color:#ff4d4f;">*</span></label>
            ...
            <div class="form-card mb-4" style="border-radius:4px; background:#ffffff; border:1px solid #e2e8f0; padding:20px;">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2.5 mb-3">
                    <h6 class="fw-bold text-dark mb-0 d-flex align-items-center gap-2" style="font-size:14.5px;">
                        <i class="fa-solid fa-list-check text-primary"></i> Step 5 — Amenities &amp; Facilities
                    </h6>
                    <span class="text-secondary" style="font-size:11.5px;">Select all active amenities</span>
                </div>
                <div class="row g-2">
                    @foreach([
                    ...
                    <div class="col-6 col-md-3">
                        <div class="p-2 border bg-light d-flex align-items-center gap-2" style="border-radius:4px; cursor:pointer; font-size:12.5px;">
                        ...
                        <div class="p-3 border bg-light" style="border-radius:4px;">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="room_price[]" class="form-control form-control-sm" placeholder="{{ $r[1] }}" style="font-size:12px; border-radius:4px;">
                                </div>
                                <div class="col-6">
                                    <label class="form-label text-secondary mb-1" style="font-size:11px;">Available Qty</label>
                                    <input type="number" name="room_qty[]" class="form-control form-control-sm" placeholder="{{ $r[2] }}" style="font-size:12px; border-radius:4px;">
                                </div>
            ...
            <div class="d-flex align-items-center justify-content-end gap-2 py-2">
                <a href="{{ route('admin.properties.index') }}" class="btn btn-light text-secondary border fw-bold px-4 py-2" style="border-radius:4px; font-size:13px;">
                    Cancel
                </a>
                <button type="submit" name="action" value="draft" class="btn btn-outline-secondary fw-bold px-4 py-2" style="border-radius:4px; font-size:13px;">
                    Save as Draft <i class="fa-solid fa-floppy-disk ms-1"></i>
                </button>
                <button type="submit" name="action" value="publish" class="btn btn-primary text-white fw-bold px-4 py-2" style="background-color:var(--primary); border-radius:4px; font-size:13px; border:none;">
