...
@section('title', 'SaaS Vendor Tenants | Prime Aviation Admin')
                ...
                @forelse($tenants as $tenant)
                    <tr>
                        ...
                        <td style="text-align:right; white-space:nowrap;">
                            <button class="btn-table-action primary me-1" data-bs-toggle="modal" data-bs-target="#editTenantModal{{ $tenant->id }}">
                                Edit <i class="fa-solid fa-pen"></i>
                            </button>
                            <form action="{{ route('admin.tenants.toggle', $tenant->id) }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="btn-table-action warning me-1">
                                    {{ $tenant->status === 'active' ? 'Suspend' : 'Activate' }}
                                </button>
                            </form>
                            <form action="{{ route('admin.tenants.destroy', $tenant->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this tenant?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-table-action danger">
