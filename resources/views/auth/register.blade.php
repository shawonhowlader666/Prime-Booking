...
@section('title', 'Create Account — Prime Booking')
@section('meta_description', 'Create your free Prime Booking account and get access to exclusive hotel deals, loyalty rewards and free cancellation.')
            ...
            <div class="col-12 col-sm-10 col-md-7 col-lg-5 col-xl-4">
                ...
                <div class="rounded-4 p-4 p-md-5" style="background:rgba(255,255,255,0.98);box-shadow:0 24px 80px rgba(0,0,0,0.35);">
                    ...
                    <div class="text-center mb-4">
                        <x-logo height="40" />
                        <h1 class="fw-bold mt-3 mb-1 text-dark" style="font-size:22px;letter-spacing:-0.3px;">Create your free account</h1>
                        <p class="text-secondary mb-0" style="font-size:13px;">Join millions of travellers on Prime Booking</p>
                    </div>
                    ...
                    <div class="d-flex flex-column" style="gap:10px;margin-bottom:20px;">
                        ...
                        <a href="{{ route('auth.social.redirect', 'google') }}"
                           ...
                           style="background:#2067e1;border-radius:24px;height:46px;font-size:14px;text-decoration:none;border:none;">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-4">
                        ...
                        <span class="text-secondary px-2" style="font-size:12px;">or register with email</span>
                        <hr class="flex-grow-1 m-0" style="border-color:#e2e8f0;">
                    </div>
                    ...
                    <form action="{{ route('register.post') }}" method="POST" novalidate>
                        ...
                        {{-- Full Name --}}
                        <div class="mb-3">
                            <label for="reg-name" class="form-label fw-semibold text-dark" style="font-size:13px;">Full Name</label>
                            <input type="text" name="name" id="reg-name"
                                   class="form-control rounded-3 @error('name') is-invalid @enderror"
                                   style="height:46px;font-size:14px;border-color:#cbd5e1;"
                                   value="{{ old('name') }}" placeholder="John Doe" autocomplete="name" required>
                            @error('name')
                        ...
                        {{-- Email --}}
                        <div class="mb-3">
                            <label for="reg-email" class="form-label fw-semibold text-dark" style="font-size:13px;">Email address</label>
                        ...
                        {{-- Password --}}
                        <div class="mb-3">
                            <label for="reg-password" class="form-label fw-semibold text-dark" style="font-size:13px;">Password</label>
                            <div class="position-relative">
                                ...
                                <button type="button" class="btn btn-link position-absolute top-50 end-0 translate-middle-y me-2 p-1 text-secondary shadow-none"
                                        onclick="togglePassword('reg-password', this)" style="font-size:14px;">
                            ...
                            <div class="mt-1 text-secondary" style="font-size:11.5px;">
                                <i class="fa-solid fa-circle-info me-1"></i>Must be at least 8 characters with letters and numbers.
                            </div>
                        </div>

                        {{-- Confirm Password --}}
                        <div class="mb-4">
                            <label for="reg-password-confirm" class="form-label fw-semibold text-dark" style="font-size:13px;">Confirm Password</label>
                            <div class="position-relative">
                                ...
                                <button type="button" class="btn btn-link position-absolute top-50 end-0 translate-middle-y me-2 p-1 text-secondary shadow-none"
                                        onclick="togglePassword('reg-password-confirm', this)" style="font-size:14px;">
                                    <i class="fa-regular fa-eye"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <button type="submit" id="btn-register-submit"
                                ...
                                style="background:#2067e1;border-radius:24px;height:48px;font-size:15px;border:none;">
                            Create Free Account
                        </button>
                    </form>
                    ...
                    <div class="text-center mt-4" style="font-size:13.5px;">
                        ...
                        <a href="{{ route('login') }}" class="fw-bold text-decoration-none ms-1" style="color:#2067e1;">Sign in</a>
                    </div>
