...
<header class="navbar navbar-expand-lg navbar-light bg-white border-bottom py-0" style="min-height: 72px; height: 72px; z-index: 1050; border-color: #e5e7eb !important; box-shadow: 0 1px 2px rgba(0,0,0,0.03);">
    <div class="container-fluid" style="height: 72px; max-width: 1360px; margin: 0 auto; padding-left: 12px; padding-right: 12px; display: flex; align-items: center;">
        ...
        <div class="collapse navbar-collapse py-0 d-none d-lg-flex" id="agodaMainNav" style="height: 72px;">
            ...
            <ul class="navbar-nav align-items-center flex-nowrap mb-0" style="font-size: 14px; white-space: nowrap; gap: 28px;">
                <li class="nav-item">
                    <a class="nav-link px-0 fw-semibold" href="{{ route('home') }}"
                       style="color: #2d2d2d; height: 72px; display: flex; align-items: center; font-size: 14px;">
                        {{ __('Hotels & Homes') }}
                    </a>
                </li>
                ...
                <li class="nav-item dropdown position-relative">
                    ...
                    <a class="nav-link dropdown-toggle px-0" href="#" role="button" data-bs-toggle="dropdown"
                       style="color: #475569; height: 72px; display: flex; align-items: center; padding-top: 4px; font-size: 14px; font-weight: 500;">
                        {{ __('Transport') }}
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('packages') }}"
                       style="color: #475569; height: 72px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Things to do') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('services') }}"
                       style="color: #475569; height: 72px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Coupons & Deals') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('search.index') }}?type=apartment"
                       style="color: #475569; height: 72px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Apartments') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0 fw-bold" href="#"
                       style="color: #475569; height: 72px; display: flex; align-items: center; font-size: 14px; letter-spacing: 1px;">•••</a>
                </li>
            </ul>
