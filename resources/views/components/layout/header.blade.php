...
<header class="navbar navbar-expand-lg navbar-light bg-white border-bottom py-0" style="min-height: 58px; height: 58px; z-index: 1050; border-color: #e5e7eb !important; box-shadow: 0 1px 2px rgba(0,0,0,0.03);">
    <div class="container-fluid" style="height: 58px; width: 100%; margin: 0; padding-left: 28px; padding-right: 28px; display: flex; align-items: center;">
        ...
        {{-- Desktop Nav Row --}}
        <div class="collapse navbar-collapse py-0 d-none d-lg-flex" id="agodaMainNav" style="height: 58px;">

            {{-- Left Nav Links (Exact Agoda screenshot gaps & font size) --}}
            <ul class="navbar-nav align-items-center flex-nowrap mb-0" style="font-size: 14px; white-space: nowrap; gap: 30px;">
                <li class="nav-item">
                    <a class="nav-link px-0 fw-semibold" href="{{ route('home') }}"
                       style="color: #2d2d2d; height: 58px; display: flex; align-items: center; font-size: 14px;">
                        {{ __('Hotels & Homes') }}
                    </a>
                </li>
                ...
                <li class="nav-item dropdown position-relative">
                    <div style="position: absolute; top: 5px; left: -2px; z-index: 10; pointer-events: none;">
                    ...
                    <a class="nav-link dropdown-toggle px-0" href="#" role="button" data-bs-toggle="dropdown"
                       style="color: #475569; height: 58px; display: flex; align-items: center; padding-top: 4px; font-size: 14px; font-weight: 500;">
                        {{ __('Transport') }}
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('packages') }}"
                       style="color: #475569; height: 58px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Things to do') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('services') }}"
                       style="color: #475569; height: 58px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Coupons & Deals') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0" href="{{ route('search.index') }}?type=apartment"
                       style="color: #475569; height: 58px; display: flex; align-items: center; font-size: 14px; font-weight: 500;">{{ __('Apartments') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-0 fw-bold" href="#"
                       style="color: #475569; height: 58px; display: flex; align-items: center; font-size: 15px; letter-spacing: 1px;">•••</a>
                </li>
            </ul>

            {{-- Right Controls (Agoda Screenshot 100% Exact 1:1 Matching Spacing & Height) --}}
            <div class="d-flex align-items-center ms-auto flex-shrink-0" style="gap: 26px; white-space: nowrap; height: 58px;">
