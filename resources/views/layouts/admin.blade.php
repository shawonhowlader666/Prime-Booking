...
<head>
    ...
    <style>
        ...
        /* ============================================================
         * Action 3-Dot & Gear Dropdown Styles for Admin & Vendor Tables
         * ============================================================ */
...
<body>
    ...
    <aside id="stockiflySidebar">
        ...
        <nav style="padding: 8px 0 60px 0; flex: 1; overflow-y: auto;">
            ...
            {{-- 5. User Portals, Trips & Experience Center (All User Portals & Dynamic Feeds in 1 Main Hub) --}}
            @php $isPortalsActive = request()->routeIs('admin.vip.*', 'admin.rewards.*', 'admin.reviews.*', 'admin.bookings.*', 'admin.properties.*', 'admin.packages.*', 'admin.inquiries.*'); @endphp
            <div class="sb-nav-group">
            ...
            <div class="admin-topbar-right">
                ...
                <div
                    ...
                    <div class="d-none d-sm-block">
                        ...
                        <span class="topbar-user-role">{{ (auth()->user()?->role ?? 'admin') === 'admin' ? 'Super Administrator' : ucfirst(auth()->user()?->role ?? 'Admin') }}</span>
                    </div>
                </div>
    ...
    // ── 7. TABLE MASTER SELECT ALL ROWS ──────────────────────────────
    ...
    // ── 8. COLUMN VISIBILITY (GEAR POPUP) ────────────────────────────
