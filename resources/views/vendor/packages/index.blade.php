                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                <a href="{{ route('packages.show', $pkg->slug) }}" target="_blank" class="btn btn-sm btn-outline-secondary rounded-pill me-1" title="View Public Page">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <form action="{{ route('vendor.packages.destroy', $pkg->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this package?');">
                                    @csrf
                                    @method('DELETE')
