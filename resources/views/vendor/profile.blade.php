        ...
        <div class="col-lg-4">
            <div class="stockifly-card p-3 text-center">
                <div style="width:90px;height:90px;border-radius:50%;overflow:hidden;border:3px solid var(--primary);margin:0 auto 12px;">
                    <img src="{{ $user->avatar ?: ('https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=fa8c16&color=fff&size=90') }}" class="w-100 h-100" style="object-fit:cover;" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=fa8c16&color=fff&size=90'">
                </div>
        ...
        <div class="col-lg-8">
            <form id="vendorProfileForm" action="{{ route('vendor.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="stockifly-card p-3 mb-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6"><label class="saas-label">Full Name</label><input type="text" name="name" class="form-control saas-input" value="{{ old('name', $user->name) }}" required></div>
                        <div class="col-md-6"><label class="saas-label">Email Address</label><input type="email" name="email" class="form-control saas-input" value="{{ old('email', $user->email) }}" required></div>
