                        ...
                        <div class="d-flex align-items-center gap-2 mt-2">
                            <div class="d-flex flex-column gap-1.5" style="width: 100px;">
                                <div class="border rounded-2 p-1 px-2 d-flex align-items-center justify-content-between" style="background: #ffffff; border-color: #cbd5e1 !important; height: 32px;">
                                    <span class="text-secondary fw-semibold" style="font-size: 10.5px;"><?php echo e(\App\Helpers\CurrencyHelper::current()); ?></span>
                                ...
                                <div class="border rounded-2 p-1 px-2 d-flex align-items-center justify-content-between" style="background: #ffffff; border-color: #cbd5e1 !important; height: 32px;">
                                    <span class="text-secondary fw-semibold" style="font-size: 10.5px;"><?php echo e(\App\Helpers\CurrencyHelper::current()); ?></span>
                                    <input type="number" id="mapMaxBudgetInput" class="form-control border-0 p-0 shadow-none fw-bold text-end text-dark" value="<?php echo e($maxConvertedPrice ?? 1000); ?>" min="0" max="1000000" style="font-size: 12px; width: 55px; background: transparent;" oninput="onMapTypedBudgetChange()">
                                </div>
                            </div>
                ...
                <div id="agodaMapCardsCol" class="bg-white border-end overflow-y-auto p-3" style="width: 440px; min-width: 420px; flex-shrink: 0; border-color: #eef2f6 !important;">
                    ...
                    <div class="mb-3 pb-2.5 border-bottom" style="border-color: #eef2f6 !important;">
                        ...
                        <div class="text-secondary small d-flex align-items-center gap-1.5 mb-2.5" style="font-size: 12.5px; color: #475569 !important;">
                            <i class="fa-regular fa-calendar" style="font-size: 11.5px;"></i> <?php echo e($checkinCarbon->diffInDays($checkoutCarbon)); ?> nights (<?php echo e($checkinCarbon->format('M j')); ?> – <?php echo e($checkoutCarbon->format('M j')); ?>)
                        </div>
