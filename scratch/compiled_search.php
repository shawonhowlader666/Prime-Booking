                        ...
                        <div class="d-flex align-items-center gap-2 mt-1.5">
                            <div class="d-flex flex-column gap-1" style="width: 90px;">
                                <div class="border rounded p-1 px-1.5 d-flex align-items-center justify-content-between" style="background: #ffffff; border-color: #cbd5e1 !important; height: 28px;">
                                    <span class="text-secondary fw-semibold" style="font-size: 10px;"><?php echo e(\App\Helpers\CurrencyHelper::current()); ?></span>
                                ...
                                <div class="border rounded p-1 px-1.5 d-flex align-items-center justify-content-between" style="background: #ffffff; border-color: #cbd5e1 !important; height: 28px;">
                                    <span class="text-secondary fw-semibold" style="font-size: 10px;"><?php echo e(\App\Helpers\CurrencyHelper::current()); ?></span>
                                    <input type="number" id="mapMaxBudgetInput" class="form-control border-0 p-0 shadow-none fw-bold text-end text-dark" value="<?php echo e($maxConvertedPrice ?? 1000); ?>" min="0" max="1000000" style="font-size: 11.5px; width: 50px; background: transparent;" oninput="onMapTypedBudgetChange()">
                                </div>
                            </div>
