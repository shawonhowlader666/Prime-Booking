...
stdin, stdout, stderr = ssh.exec_command("cd applications/yayxamnaue/public_html/laravel && php artisan view:clear && php artisan cache:clear && php artisan optimize:clear")
print("[OPTIMIZE]:\n" + stdout.read().decode())

# Test /hotels/217
stdin, stdout, stderr = ssh.exec_command("cd applications/yayxamnaue/public_html/laravel && php test_hotel.php")
output = stdout.read().decode('utf-8', errors='ignore')
print("[HOTEL 217 TEST RESULT]:\n" + output)
