...
stdin, stdout, stderr = ssh.exec_command("cd applications/yayxamnaue/public_html/laravel && php artisan optimize:clear")
print("[OPTIMIZE]:\n" + stdout.read().decode())

ssh.close()
print("All files synchronized and caches cleared successfully!")
